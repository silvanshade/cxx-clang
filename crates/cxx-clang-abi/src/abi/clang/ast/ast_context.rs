...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "ast_context"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/ASTContext.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::ast_context";
