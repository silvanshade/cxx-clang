...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "cxx_deduction_guide_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/CXXDeductionGuideDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::cxx_deduction_guide_decl";
    let cxx_name = "CXXDeductionGuideDecl";
    let rust_name = "CxxDeductionGuideDecl";
