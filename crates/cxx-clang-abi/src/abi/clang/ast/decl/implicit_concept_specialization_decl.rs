...
#[cxx::bridge]
mod ffi {
    #[namespace = "cxx_clang::clang::ast::decl::implicit_concept_specialization_decl"]
    unsafe extern "C++" {
        include!("cxx-clang-abi/cxx/include/clang/AST/Decl/ImplicitConceptSpecializationDecl.hxx");
...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "implicit_concept_specialization_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ImplicitConceptSpecializationDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::implicit_concept_specialization_decl";
    let cxx_name = "ImplicitConceptSpecializationDecl";
    let rust_name = "ImplicitConceptSpecializationDecl";
