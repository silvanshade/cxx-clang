...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "translation_unit_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/TranslationUnitDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::translation_unit_decl";
    let cxx_name = "TranslationUnitDecl";
    let rust_name = "TranslationUnitDecl";
