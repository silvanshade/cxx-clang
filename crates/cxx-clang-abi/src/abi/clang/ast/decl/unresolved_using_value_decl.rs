...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "unresolved_using_value_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/UnresolvedUsingValueDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::unresolved_using_value_decl";
    let cxx_name = "UnresolvedUsingValueDecl";
    let rust_name = "UnresolvedUsingValueDecl";
