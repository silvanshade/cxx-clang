...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_property_impl_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCPropertyImplDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_property_impl_decl";
    let cxx_name = "ObjCPropertyImplDecl";
    let rust_name = "ObjCPropertyImplDecl";
