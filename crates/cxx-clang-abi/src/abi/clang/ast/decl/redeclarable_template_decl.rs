...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "redeclarable_template_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/RedeclarableTemplateDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::redeclarable_template_decl";
    let cxx_name = "RedeclarableTemplateDecl";
    let rust_name = "RedeclarableTemplateDecl";
