...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "omp_declarative_directive_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/OMPDeclarativeDirectiveDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::omp_declarative_directive_decl";
    let cxx_name = "OMPDeclarativeDirectiveDecl";
    let rust_name = "OmpDeclarativeDirectiveDecl";
