...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_at_defs_field_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCAtDefsFieldDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_at_defs_field_decl";
    let cxx_name = "ObjCAtDefsFieldDecl";
    let rust_name = "ObjCAtDefsFieldDecl";
