...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "type_alias_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/TypeAliasDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::type_alias_decl";
    let cxx_name = "TypeAliasDecl";
    let rust_name = "TypeAliasDecl";
