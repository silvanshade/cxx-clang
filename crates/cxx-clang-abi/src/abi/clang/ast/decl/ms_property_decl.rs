...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "ms_property_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/MSPropertyDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::ms_property_decl";
    let cxx_name = "MSPropertyDecl";
    let rust_name = "MsPropertyDecl";
