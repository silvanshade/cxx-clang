...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "using_enum_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/UsingEnumDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::using_enum_decl";
    let cxx_name = "UsingEnumDecl";
    let rust_name = "UsingEnumDecl";
