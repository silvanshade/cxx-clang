...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "static_assert_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/StaticAssertDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::static_assert_decl";
    let cxx_name = "StaticAssertDecl";
    let rust_name = "StaticAssertDecl";
