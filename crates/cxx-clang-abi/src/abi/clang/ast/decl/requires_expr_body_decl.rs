...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "requires_expr_body_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/RequiresExprBodyDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::requires_expr_body_decl";
    let cxx_name = "RequiresExprBodyDecl";
    let rust_name = "RequiresExprBodyDecl";
