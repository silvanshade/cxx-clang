...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "omp_declarative_directive_value_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/OMPDeclarativeDirectiveValueDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::omp_declarative_directive_value_decl";
    let cxx_name = "OMPDeclarativeDirectiveValueDecl";
    let rust_name = "OmpDeclarativeDirectiveValueDecl";
