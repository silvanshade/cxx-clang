...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "linkage_spec_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/LinkageSpecDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::linkage_spec_decl";
    let cxx_name = "LinkageSpecDecl";
    let rust_name = "LinkageSpecDecl";
