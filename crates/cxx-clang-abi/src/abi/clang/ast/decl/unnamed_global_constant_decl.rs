...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "unnamed_global_constant_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/UnnamedGlobalConstantDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::unnamed_global_constant_decl";
    let cxx_name = "UnnamedGlobalConstantDecl";
    let rust_name = "UnnamedGlobalConstantDecl";
