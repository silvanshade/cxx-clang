...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "using_directive_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/UsingDirectiveDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::using_directive_decl";
    let cxx_name = "UsingDirectiveDecl";
    let rust_name = "UsingDirectiveDecl";
