...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "cxx_conversion_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/CXXConversionDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::cxx_conversion_decl";
    let cxx_name = "CXXConversionDecl";
    let rust_name = "CxxConversionDecl";
