...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "base_using_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/BaseUsingDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::base_using_decl";
    let cxx_name = "BaseUsingDecl";
    let rust_name = "BaseUsingDecl";
