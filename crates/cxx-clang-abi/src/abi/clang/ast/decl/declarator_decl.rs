...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "declarator_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/DeclaratorDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::declarator_decl";
    let cxx_name = "DeclaratorDecl";
    let rust_name = "DeclaratorDecl";
