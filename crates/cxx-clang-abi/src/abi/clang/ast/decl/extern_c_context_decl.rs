...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "extern_c_context_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ExternCContextDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::extern_c_context_decl";
    let cxx_name = "ExternCContextDecl";
    let rust_name = "ExternCContextDecl";
