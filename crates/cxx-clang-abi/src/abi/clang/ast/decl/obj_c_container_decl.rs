...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_container_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCContainerDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_container_decl";
    let cxx_name = "ObjCContainerDecl";
    let rust_name = "ObjCContainerDecl";
