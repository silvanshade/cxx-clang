...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "indirect_field_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/IndirectFieldDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::indirect_field_decl";
    let cxx_name = "IndirectFieldDecl";
    let rust_name = "IndirectFieldDecl";
