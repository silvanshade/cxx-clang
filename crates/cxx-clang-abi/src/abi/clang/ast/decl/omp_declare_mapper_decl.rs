...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "omp_declare_mapper_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/OMPDeclareMapperDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::omp_declare_mapper_decl";
    let cxx_name = "OMPDeclareMapperDecl";
    let rust_name = "OmpDeclareMapperDecl";
