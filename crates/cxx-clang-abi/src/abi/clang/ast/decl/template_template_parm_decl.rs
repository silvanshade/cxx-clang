...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "template_template_parm_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/TemplateTemplateParmDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::template_template_parm_decl";
    let cxx_name = "TemplateTemplateParmDecl";
    let rust_name = "TemplateTemplateParmDecl";
