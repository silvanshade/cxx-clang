...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "access_spec_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/AccessSpecDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::access_spec_decl";
    let cxx_name = "AccessSpecDecl";
    let rust_name = "AccessSpecDecl";
