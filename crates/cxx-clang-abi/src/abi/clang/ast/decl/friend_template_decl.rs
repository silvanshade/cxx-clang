...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "friend_template_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/FriendTemplateDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::friend_template_decl";
    let cxx_name = "FriendTemplateDecl";
    let rust_name = "FriendTemplateDecl";
