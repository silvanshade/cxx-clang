...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "lifetime_extended_temporary_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/LifetimeExtendedTemporaryDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::lifetime_extended_temporary_decl";
    let cxx_name = "LifetimeExtendedTemporaryDecl";
    let rust_name = "LifetimeExtendedTemporaryDecl";
