...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "builtin_template_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/BuiltinTemplateDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::builtin_template_decl";
    let cxx_name = "BuiltinTemplateDecl";
    let rust_name = "BuiltinTemplateDecl";
