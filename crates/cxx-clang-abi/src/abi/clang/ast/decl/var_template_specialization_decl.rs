...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "var_template_specialization_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/VarTemplateSpecializationDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::var_template_specialization_decl";
    let cxx_name = "VarTemplateSpecializationDecl";
    let rust_name = "VarTemplateSpecializationDecl";
