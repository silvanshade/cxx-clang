...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_ivar_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCIvarDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_ivar_decl";
    let cxx_name = "ObjCIvarDecl";
    let rust_name = "ObjCIvarDecl";
