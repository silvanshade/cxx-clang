...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "template_param_object_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/TemplateParamObjectDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::template_param_object_decl";
    let cxx_name = "TemplateParamObjectDecl";
    let rust_name = "TemplateParamObjectDecl";
