...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "pragma_comment_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/PragmaCommentDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::pragma_comment_decl";
    let cxx_name = "PragmaCommentDecl";
    let rust_name = "PragmaCommentDecl";
