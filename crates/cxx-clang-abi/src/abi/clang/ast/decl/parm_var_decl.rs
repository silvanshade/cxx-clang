...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "parm_var_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ParmVarDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::parm_var_decl";
    let cxx_name = "ParmVarDecl";
    let rust_name = "ParmVarDecl";
