...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_property_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCPropertyDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_property_decl";
    let cxx_name = "ObjCPropertyDecl";
    let rust_name = "ObjCPropertyDecl";
