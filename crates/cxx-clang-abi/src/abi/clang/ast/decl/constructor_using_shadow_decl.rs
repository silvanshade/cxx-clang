...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "constructor_using_shadow_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ConstructorUsingShadowDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::constructor_using_shadow_decl";
    let cxx_name = "ConstructorUsingShadowDecl";
    let rust_name = "ConstructorUsingShadowDecl";
