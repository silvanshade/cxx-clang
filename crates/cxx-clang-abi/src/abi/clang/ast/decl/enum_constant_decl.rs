...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "enum_constant_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/EnumConstantDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::enum_constant_decl";
    let cxx_name = "EnumConstantDecl";
    let rust_name = "EnumConstantDecl";
