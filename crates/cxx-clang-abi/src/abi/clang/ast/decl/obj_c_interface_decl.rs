...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_interface_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCInterfaceDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_interface_decl";
    let cxx_name = "ObjCInterfaceDecl";
    let rust_name = "ObjCInterfaceDecl";
