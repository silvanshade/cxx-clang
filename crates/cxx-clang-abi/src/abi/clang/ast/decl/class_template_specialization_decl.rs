...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "class_template_specialization_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ClassTemplateSpecializationDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::class_template_specialization_decl";
    let cxx_name = "ClassTemplateSpecializationDecl";
    let rust_name = "ClassTemplateSpecializationDecl";
