...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "var_template_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/VarTemplateDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::var_template_decl";
    let cxx_name = "VarTemplateDecl";
    let rust_name = "VarTemplateDecl";
