...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_protocol_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCProtocolDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_protocol_decl";
    let cxx_name = "ObjCProtocolDecl";
    let rust_name = "ObjCProtocolDecl";
