...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "namespace_alias_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/NamespaceAliasDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::namespace_alias_decl";
    let cxx_name = "NamespaceAliasDecl";
    let rust_name = "NamespaceAliasDecl";
