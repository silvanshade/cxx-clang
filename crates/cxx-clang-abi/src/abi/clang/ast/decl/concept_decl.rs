...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "concept_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ConceptDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::concept_decl";
    let cxx_name = "ConceptDecl";
    let rust_name = "ConceptDecl";
