...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_category_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCCategoryDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_category_decl";
    let cxx_name = "ObjCCategoryDecl";
    let rust_name = "ObjCCategoryDecl";
