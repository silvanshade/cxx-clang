...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "obj_c_type_param_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/ObjCTypeParamDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::obj_c_type_param_decl";
    let cxx_name = "ObjCTypeParamDecl";
    let rust_name = "ObjCTypeParamDecl";
