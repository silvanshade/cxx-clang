...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "ast", "decl", "non_type_template_parm_decl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/AST/Decl/NonTypeTemplateParmDecl.hxx";
    let cxx_namespace = "cxx_clang::clang::ast::decl::non_type_template_parm_decl";
    let cxx_name = "NonTypeTemplateParmDecl";
    let rust_name = "NonTypeTemplateParmDecl";
