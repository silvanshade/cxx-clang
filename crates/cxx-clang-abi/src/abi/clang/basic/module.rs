...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["clang", "basic", "module"];
    let path_descendants = vec![];
    let cxx_include = "cxx-clang-abi/cxx/include/clang/Basic/Module.hxx";
    let cxx_namespace = "cxx_clang::clang::basic::module";
    let cxx_name = "Module";
