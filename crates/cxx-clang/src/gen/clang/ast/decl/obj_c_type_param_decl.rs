...
mod ffi {
    extern "C++" {
        ...
        type ObjCTypeParamDecl<'ctx> =
            crate::ffi::clang::ast::decl::obj_c_type_param_decl::ObjCTypeParamDecl<'ctx>;
    ...
    #[namespace = "cxx_clang::clang::ast::decl::obj_c_type_param_decl"]
    unsafe extern "C++" {
        fn as_ref_typedef_name_decl<'this, 'ctx>(
            This: &'this ObjCTypeParamDecl<'ctx>,
        ) -> &'this TypedefNameDecl<'ctx>;
