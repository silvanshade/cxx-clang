...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn as_pin_decl<'this, 'ctx>(This: Pin<&'this mut LinkageSpecDecl<'ctx>>) -> Pin<&'this mut Decl<'ctx>>;

        fn as_ref_decl_context<'this, 'ctx>(This: &'this LinkageSpecDecl<'ctx>) -> &'this DeclContext<'ctx>;
